Per connettere tra loro più LAN si utilizzano i Router del livello $3$ della pila [[000. Introduzione al corso#Protocolli di rete|ISO-OSI]], insieme ad una **backbone**, ovvero il collegamento vero e proprio (la cablatura).
...
- si ha comunicazione [[000. Introduzione al corso#Reti a commutazione di pacchetto#Servizi orientati alla connessione e non|connectionless]];
